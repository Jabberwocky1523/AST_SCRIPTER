                  ...
                  bool src_pad_flag, bool dst_pad_flag, bool palette_flag)
{
    size_t width_pad = 0;
    if (src_pad_flag)
        width_pad = (4 - width * byte_per_pixel % 4) % 4;
    ...
    {
        if (rescaled_tmp2_buffer)
            delete[] rescaled_tmp2_buffer;
                        ...
                        int quality, bool bmp2jpeg_flag)
{
    ...
    if (cinfo2.image_width == 0)
        cinfo2.image_width = 1;
    cinfo2.image_height = (int)(height * scale_ratio_upper / scale_ratio_lower);
    if (cinfo2.image_height == 0)
        cinfo2.image_height = 1;
                  ...
                  bool output_jpeg_flag, int quality)
{
    ...
    if (bit_per_pixel == 8 && color_num == 0)
        color_num = 256;
